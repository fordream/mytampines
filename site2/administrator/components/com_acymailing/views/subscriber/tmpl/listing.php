	...
	<table>
		<tr>
			<td width="100%">
				...
				<button onclick="document.getElementById('search').value='';document.adminForm.limitstart.value=0;this.form.submit();"><?php echo JText::_( 'JOOMEXT_RESET' ); ?></button>
			...
			?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<?php foreach($this->displayFields as $map => $oneField){
						...
						<td>
						<?php
						if($map =='email') echo '<a href="'.acymailing_completeLink('subscriber&task=edit&subid='.$row->subid).'">';
