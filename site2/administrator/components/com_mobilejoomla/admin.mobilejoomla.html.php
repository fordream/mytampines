		...
		if(count($tabs) < 1)
		{
			...
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<?php echo JText::_('COM_MJ__NO_EXTENSIONS'); ?><br/><br/>
					<?php echo JText::_('COM_MJ__FIND_MORE_EXTENSIONS'); ?> <a
							href="http://www.mobilejoomla.com/"><?php echo JText::_('COM_MJ__MOBILEJOOMLA_HOMEPAGE'); ?></a>.
					</td>
				</tr>
				</tbody>
			</table>
