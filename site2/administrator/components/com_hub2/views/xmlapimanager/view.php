...
class Hub2ViewXmlapimanager extends JView {
    function setToolbar() {
        JToolBarHelper::title( JText::_( 'ADMIN_XMLAPIMANAGER_TITLE' ), 'logo' );
        JToolBarHelper::trash( 'trash' );
        JToolBarHelper::custom( 'edit', 'edit.png', 'edit_f2.png', 'Edit', true );
        JToolBarHelper::custom( 'edit', 'new.png',
        'new_f2.png', 'Add', false );
    }
    ...
    function setEditToolBar() {
        ...
        JText::_( ($isNew ? 'ADMIN_XMLAPIMANAGER_TITLE_ADD' :
                    'ADMIN_XMLAPIMANAGER_TITLE_EDIT')), 'logo' );
        JToolBarHelper::save();
    ...
    function display($tpl=null) {
        ...
        $lang->load('com_hub2_xmlapi', JPATH_ADMINISTRATOR);
        // save current state
        $viewName = 'xmlapimanager';
