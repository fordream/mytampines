window.addEvent('domready', function(){
	...
	if (a) {
		...
		a.addEvent('click', function(){
			new Json.Remote('index.php?option=com_contentmanager&task=dashboard.enablePlugin&tmpl=component&protocol=json', {linkId: this.getProperty('id'), onComplete: function(response){
