<?php
/**
 * @version		$Id: uninstall.php 52 2008-01-17 01:25:06Z andrew.eddie $
...
<table class="adminlist">
	...
	<tbody>
		<tr class="row0">
			<td class="key" colspan="2"><?php echo JText::_('Control').' '.JText::_('Component'); ?></td>
