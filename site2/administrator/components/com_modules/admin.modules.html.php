				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						...
						if (is_null( $row->pages )) {
							...
							echo JText::_( 'Varies' );
					    /** Hyperlocalizer - display for negative numbers */
						} else if ($row->pages < 0) {
                            echo JText::_( 'Varies' );
                        /** end Hyperlocalizer - display for negative numbers */
						} else {
							echo JText::_( 'All' );
						}
						?>
			...
			<fieldset class="adminform">
				...
				<table class="admintable" cellspacing="1">
					<tr>
						...
						<td>
						<?php /** Hyperlocalizer added support to select inverse */ ?>
						<?php if ($row->client_id != 1) : ?>
                            ...
                            <label for="menus-select-inverse"><input id="menus-select-inverse" type="radio" name="menus" value="inverse" onclick="enableselections();" /><?php echo JText::_( 'Select not on Menu' ); ?></label>
							...
							<label for="menus-select"><input id="menus-select" type="radio" name="menus" value="select" onclick="enableselections();" /><?php echo JText::_( 'Select From List' ); ?></label>
                            <label for="menus-select-inverse"><input id="menus-select-inverse" type="radio" name="menus" value="inverse" onclick="enableselections();" /><?php echo JText::_( 'Select not on Menu' ); ?></label>
                            <?php } elseif ($row->pages == 'inverse') { ?>
                            <label for="menus-all"><input id="menus-all" type="radio" name="menus" value="all" onclick="allselections();" /><?php echo JText::_( 'All' ); ?></label>
                            <label for="menus-none"><input id="menus-none" type="radio" name="menus" value="none" onclick="disableselections();" checked="checked" /><?php echo JText::_( 'None' ); ?></label>
                            <label for="menus-select"><input id="menus-select" type="radio" name="menus" value="select" onclick="enableselections();" /><?php echo JText::_( 'Select From List' ); ?></label>
                            <label for="menus-select-inverse"><input id="menus-select-inverse" type="radio" name="menus" value="inverse" onclick="enableselections();" checked="checked"/><?php echo JText::_( 'Select not on Menu' ); ?></label>
							<?php } else { ?>
							<label for="menus-all"><input id="menus-all" type="radio" name="menus" value="all" onclick="allselections();" /><?php echo JText::_( 'All' ); ?></label>
							<label for="menus-none"><input id="menus-none" type="radio" name="menus" value="none" onclick="disableselections();" /><?php echo JText::_( 'None' ); ?></label>
